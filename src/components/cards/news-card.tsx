      ...
      <article className="group flex h-full items-center gap-3.5 sm:gap-4 overflow-hidden rounded-xl border border-slate-200/90 bg-white p-3.5 shadow-xs transition-all duration-200 hover:border-[#006569] hover:shadow-md sm:p-4">
        <div className="relative aspect-[4/3] w-28 sm:w-36 shrink-0 overflow-hidden rounded-lg bg-slate-100">
          {article.image ? (
            ...
            <div className="flex size-full items-center justify-center text-teal-800">
              <Landmark aria-hidden="true" className="size-6" strokeWidth={1.25} />
            </div>
          )}
          <div className="absolute left-2 top-2">
            <span className="rounded bg-white/95 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-[#006569] shadow-2xs">
              {article.category}
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-1 flex-col justify-between min-w-0 h-full py-0.5">
          <div>
            ...
            <h3 className="mt-1 font-sans text-sm sm:text-base font-bold tracking-tight text-slate-900 leading-snug transition-colors group-hover:text-[#006569] line-clamp-2">
          ...
          <div className="mt-2 flex items-center justify-between border-t border-slate-100/80 pt-2">
            ...
            <a
              className="inline-flex min-h-6 items-center gap-1 text-xs font-semibold text-[#006569] hover:text-[#C45F18] transition-colors"
              href={targetHref}
            >
      ...
      <div>
        <div className="relative aspect-[16/10] w-full overflow-hidden bg-slate-100">
          ...
          <div className="absolute left-3 top-3">
            <span className="rounded bg-white/95 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-[#006569] shadow-sm">
              {article.category}
            </span>
          </div>
        </div>
        ...
        <div className="p-5">
          ...
          <h3 className="mt-2 font-sans text-base font-bold tracking-tight text-slate-900 leading-snug transition-colors group-hover:text-[#006569] line-clamp-2">
            <a href={targetHref}>{article.title}</a>
          </h3>
