      ...
      <div>
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <span className="flex size-8 items-center justify-center rounded-md bg-[#C2410C] font-sans text-xs font-bold text-white shadow-2xs">
        ...
        <h3 className="mt-4 font-sans text-lg font-bold tracking-tight text-slate-900 transition-colors group-hover:text-[#C2410C]">
          {program.name}
        </h3>
